                            ...
                            <tbody>
                                <?php 
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-outline-danger rounded-pill" href="ExamResultAdd.php?id=<?php echo $fetchRegiStu['sl_id'];?>">
                                                Add Result
                                                <?php 
                                                    $classId = $fetchRegiStu['sl_id'];
                                        ...
                                        <td>
                                          ...
                                          <a class="btn btn-sm btn-primary text-white" href="viewStudentResult.php?id=<?php echo $fetchRegiStu['sl_id'];?>"> <i class="fa-solid fa-download"> </i> Download Admit Card</a>
                                        </td>
                                      </tr>
                                      <?php 
                                        }
