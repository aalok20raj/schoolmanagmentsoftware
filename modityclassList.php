...
<?php
    ...
    $selectClass = mysqli_query($conn, "SELECT * FROM classlist WHERE cl_id ='$class_id'");
...
?>
        ...
        <title>Modify Class List Principal Dashboard - S S Convent Sarbahda</title>
<?php 
...
<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="container-fluid bg-warning rounded-top text-center h2 p-3">Modify Class</div>
                                <?php 
                                        ...
                                        if($response->success){
                                            ...
                                            if($CountCheckClass == 1){
                                                $_SESSION['status'] = "<div class='alert alert-warning'><strong>Hii </strong>This Class name exit here. Try another name.</div>";
                                                    ...
                                                    $insertDate = mysqli_query($conn, "UPDATE classlist SET cl_name='$name' WHERE cl_id='$classid'");
                                                    if($insertDate){
                                                        $_SESSION['status'] = "<div class='alert alert-success'><strong>Hey! </strong>You have Successfully Upgrade Class here.</div>";
                                                    }
                                                    else{
                                                        $_SESSION['status'] = "<div class='alert alert-success'><strong>Hey! </strong>You have not successfully Upgrade class here.</div>";
                                                    }
                                                }
                                            }
                                        }
                                ...
                                <form method="POST">
                                    <div class="form-floating mb-3 mt-3">
                                      <input type="text" class="form-control" name="name" id="floatingName" value="<?php echo $FatchClass['cl_name']; ?>" placeholder="Full Name">
                                                ...
                                                while ($fetch_dataLoop = mysqli_fetch_array($fetch_data)) {
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><a href="modifyStu_registration.php?id=<?php echo $fetch_dataLoop['cl_id'];?>" class="btn btn-sm btn-outline-danger rounded-pill">Fee List</a>
                                                            </td>
                                                            <td>
                                                                <?php 
