...
<?php include('Includes/head.php'); ?>
    <title> Gallery - STUDENTS SUCCESS CONVENT SCHOOL SARBAHDA GAYA, BIHAR</title>
...
?>
    <div class="container-fluid bg-primary text-white">
        <h1 class="pt-5 pb-5 text-center">Gallery</h1>
    </div>
    <div class="container pt-5 pb-5">
      <div class="row row-cols-2 row-cols-md-5 g-4">
        <div class="col">
          <div class="card">
            <img src="Assets/Images/teacher.avif" class="card-img-top" alt="...">
          </div>
        </div>
        <div class="col">
          <div class="card">
            <img src="Assets/Images/schoolvan.avif" class="card-img-top" alt="...">
        ...
        <div class="col">
          <div class="card">
            <img src="Assets/Images/driver.avif" class="card-img-top" alt="...">
